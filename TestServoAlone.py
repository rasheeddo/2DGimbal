...
dxl_comm_result, dxl_error=packetHandler.write4ByteTxRx(portHandler, DXL6_ID, ADDR_PRO_GOAL_POSITION, 0)
time.sleep(3)

startTime = time.time()
dxl_comm_result, dxl_error=packetHandler.write4ByteTxRx(portHandler, DXL6_ID, ADDR_PRO_GOAL_POSITION, 3000)
endTime = time.time()
