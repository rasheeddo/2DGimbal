...
def RunServo1(inputDeg1):
    ...
    servo_com1=(inputDeg1*4095.0)/360.0
    dxl1_goal_position=int(servo_com1)
...
def RunServo2(inputDeg2):
    ...
    servo_com2=(inputDeg2*4095.0)/360.0
...
######################### Set Velocity / Acceleration Profile  ##############################
#SetProfile1(1000,450)
#SetProfile2(1000,450)
...
while run:
    ...
    #ServoAng1 = map(Roll,30,-30,110,170)
    #ServoAng2 = map(Pitch,-30,30,105,165)

    ServoAng1 = 140.0 - Roll
    RunServo1(ServoAng1)
    ServoAng2 = 135.0 + Pitch
    RunServo2(ServoAng2)
