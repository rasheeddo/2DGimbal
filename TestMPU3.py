...
def GoHome12():
    servo_ang1 = map(145, 0.0, 360.0, 0, 4095)
...
def smoother(n,rawRoll,rawPitch,rawYaw):
        ...
        return sum(avRoll)/len(avRoll),sum(avPitch)/len(avPitch),sum(avYaw)/len(avYaw)
...
while True:
    ...
    #Offset correction:
    #rollDegree=rollDegree+0 #+Y_offset
    #pitchDegree=pitchDegree + 18.0 #+X_offset
